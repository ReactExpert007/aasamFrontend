...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setElements: function () {
			...
			this.main.addClass('mdi sw-theme-' + this.options.theme);
            // Set anchor elements
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text(this.options.lang.next).addClass('btn btn-primary sw-btn-next validate').attr('type', 'button') : null;
        ...
        _setButtons: function (idx) {
            ...
            if (!this.options.cycleSteps) {
                if (0 >= idx) {
                    $('.sw-btn-prev', this.main).addClass("hidden");
                } else {
                    $('.sw-btn-prev', this.main).removeClass("hidden");
                }
                if (this.steps.length - 1 <= idx) {
                    $('.sw-btn-next', this.main).addClass("hidden");
                } else {
                    $('.sw-btn-next', this.main).removeClass("hidden");
                }
